...
struct FCDesign {
    ...
    static let headerFont = UIFont(name: "WorkSans-Bold", size: 20)
    static let subHeaderFont = UIFont(name: "WorkSans-Bold", size: 14)
    static let bodyFont = UIFont(name: "WorkSans-Regular", size: 14)
    static let captionFont = UIFont(name: "WorkSans-Regular", size: 10)
}
