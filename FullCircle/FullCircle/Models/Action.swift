...
class Action: Codable {
    ...
    init(name: String, description: String, organization: Organization, engagementLevel: EngagementLevel, location: String, actionURL: String, iconString: String, isSaved: Bool, actionCode: ActionCode) {
        self.name = name
