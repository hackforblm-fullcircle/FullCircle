...
class OrgDetailViewControllerOld: UIViewController {
    ...
    //Initializer
    static func create(_ organization: Organization) -> OrgDetailViewControllerOld {
        let vc = UIStoryboard(name: "OrgDetail", bundle: nil).instantiateViewController(withIdentifier: "OrgDetailViewController") as! OrgDetailViewControllerOld
...
extension OrgDetailViewControllerOld {
